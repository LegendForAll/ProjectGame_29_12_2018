...
void StateTwo::LoadState(int AS)
{
	...
	//Groud
	BOXStair *box_dl1 = new BOXStair();
	box_dl1->LoadResource();
	box_dl1->SetPosition(3968.0f, 158);
	box_dl1->SetState(BOX_LEFT);
	objecttsStatic.push_back(box_dl1);

	BOXStair *box_dr1 = new BOXStair();
	box_dr1->LoadResource();
	box_dr1->SetPosition(4160.0f, 158);
	box_dr1->SetState(BOX_RIGHT);
	objecttsStatic.push_back(box_dr1);
